...
include "url.php";
  ...
  if($gambar != "") {
    ...
    $nama_gambar_baru = "gambar/"."produk".$idproduk.".JPG";
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, $nama_gambar_baru); //memindah file gambar ke folder gambar
					$query  = "UPDATE produk SET gambar = '$path_gambar'";
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Gambar Berhasil Diupload.');window.location='home.php?page=produk';</script>";
                    }
              } else {     
                  echo "<script>alert('Ekstensi Gambar Tidak Sesuai');window.location='home.php?page=produk';</script>";
              }
    } else {
