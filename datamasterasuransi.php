<?php 
function curl($url){
    $authorization = "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZHBlbmdndW5hIjoxLCJpYXQiOjE1OTkyODA4MjEsImV4cCI6MTU5OTI4NDQyMX0.JHVj0LXcKhri1VnVNpSGXKTfoRjifVxV95jFnkN1cbo";
    $ch = curl_init(); 
...
$profile = curl("http://35.229.217.130:9992/api/asuransi");
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Data Master Asuransi</span></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <td><?php echo $i; $i++; ?></td>
                                                ...
                                                <td><?php $dt = strtotime($row['tanggal_kontrak_awal']); echo date("Y/m/d", $dt); ?></td>
                                                <td><?php $dt = strtotime($row['tanggal_kontrak_akhir']); echo date("Y/m/d", $dt); ?></td>
                                                <th>
                                                    <form method="post">
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <?php $dt = strtotime($row['tanggal_kontrak_awal']); echo date("Y/m/d", $dt); ?>" required="true">
                    </div>
                    <div class="form-group">
                        <label for="examplePassword" class="">Tanggal Kontrak Akhir</label>
                        <input type="date" name="tanggal_kontrak_akhir" id="tanggal_kontrak_akhir" class="form-control" value="
                        <?php $dt = strtotime($row['tanggal_kontrak_akhir']); echo date("Y/m/d", $dt); ?>" required="true">
                    </div>
                        <br>
                        <button class="mt-1 btn btn-primary" type="submit">Simpan</button>
                    </form>
