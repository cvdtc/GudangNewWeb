...
function curl($url){
    ...
    $authorization = "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZHBlbmdndW5hIjoxLCJpYXQiOjE1OTkyODA3MTYsImV4cCI6MTU5OTI4NDMxNn0.c26ujnNhV2sSKpxswzgSSdOgrJ0aLXbcTrRYvaXyfy0";
    $ch = curl_init(); 
    ...
    $profile = curl("http://35.229.217.130:9992/api/lokasi");
    $profilep = curl("http://35.229.217.130:9992/api/kota");
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-list"></i><span>Master</span></a>
                                <ul class="collapse">
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Data Master lokasi</span></li>
                            </ul>
                        </div>
                    </div>
