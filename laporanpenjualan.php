                                ...
                                <table id="example" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $query = "select a.no_order, a.tanggal_order, c.kode_kontainer, e.nama_lokasi, d.kode_refrensi, nominal, d.komisi_provider, d.keterangan, d.timestamp
                                                from transaksi a, transaksi_detail b, produk c, pembayaran d, lokasi e
                                                where a.idtransaksi=b.idtransaksi and b.idproduk=c.idproduk and a.idtransaksi=d.idtransaksi and c.idlokasi=e.idlokasi;";
