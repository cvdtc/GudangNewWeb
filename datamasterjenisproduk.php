<?php 
function curl($url){
    $authorization = "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZHBlbmdndW5hIjoxLCJpYXQiOjE1OTkyNzAzMDMsImV4cCI6MTU5OTI3MzkwM30.RWmyI3BJHMqmoCb19lGlMM0pvaMu9Ym8VjP_3Ud5yEA";
    $ch = curl_init(); 
...
$profile = curl("http://35.229.217.130:9992/api/jenisproduk");
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Data Master Jenis Produk</span></li>
                            </ul>
                        </div>
                    </div>
